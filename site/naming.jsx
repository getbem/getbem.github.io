...
<div class="block block--size-big block--shadow-yes">...</div>`}</pre>
			...
			<p>Suppose you have block form with modifiers <code>theme: 'xmas'</code> and <code>simple: true</code> and with elements <code>input</code> and <code>submit</code>, and element <code>submit</code> with its own modifier <code>disabled: true</code> for not submitting form while it's not filled:</p>
