...
For building we will use [gulpjs](https://github.com/gulpjs/gulp) - it is simple streaming build system.
...
As you can see, we will write our build configuration in JavaScript. gulp has nice API, that allows you to get files quick and easy. For our needs we will get all CSS files and concatenate them with [gulp-concat](https://github.com/wearefractal/gulp-concat) plugin (there are more than [600 plugins](http://gulpjs.com/plugins/) for now):
